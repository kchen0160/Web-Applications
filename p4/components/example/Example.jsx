...
class Example extends React.Component {
  constructor(props) {
    ...
    this.handleMottoChange = event => this.handleMChange(event);
      ...
      <div className="container Example">
        <h1>Project 4 React.js Example</h1>
          ...
          <div className="motto-update">
              <label htmlFor="inMotto">Motto:
              </label>
              <input id="inMotto" type = "text" value = {this.state.motto} onChange={(this.handleMottoChange)} />
          <p>
              {this.state.name}
              <br/>
              {this.state.motto}
